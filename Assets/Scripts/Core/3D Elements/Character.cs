...
public class Character : MonoBehaviour
{
    ...
    public bool isInStartupAnim { get; private set; }
    ...
    public void ChangeBodyAnimation(string newAnimation, bool useStartupAnim = true)
    {
        ...
        if (controller)
        {
            ...
            bodyAnimator.Update(0.0f);
            if (useStartupAnim)
            {
                isInStartupAnim = true;
                bodyAnimator.SetTrigger("UseEnterAnim");
            }
        }
    }

    /// <summary>
    /// Changes the value of waiting for startup anim to finish
    /// </summary>
    /// <param name="value">Is the character waiting for the startup anim to finish ?</param>
    public void SetInStartupAnim(bool value)
    {
        isInStartupAnim = value;
    }
