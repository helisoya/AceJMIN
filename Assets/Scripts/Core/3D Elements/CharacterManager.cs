...
public class CharacterManager : MonoBehaviour
{
    ...
    /// <summary>
    /// Returns if the character is in its startup anim or not
    /// </summary>
    /// <param name="characterName">The character</param>
    /// <returns>Is the character is its startup anim ?</returns>
    public bool IsCharacterInStartupAnim(string characterName)
    {
        if (characters.ContainsKey(characterName))
        {
            return characters[characterName].isInStartupAnim;
        }
        return false;
    }
    ...
    /// <param name="useStartupAnim">Should the startup anim be used ?</param>
    public void SetCharacterBodyAnimation(string character, string animation, bool useStartupAnim = true)
    {
        if (characters.ContainsKey(character))
        {
            characters[character].ChangeBodyAnimation(animation, useStartupAnim);
        }
    }
    ...
    public void AddCharacterFromData(GAMEFILE.CHARACTERDATA characterData)
    {
        ...
        character.ChangeBodyAnimation(characterData.bodyAnimationSet, false);
